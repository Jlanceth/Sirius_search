...
def search(text: str, coll: int):
    ...
    try:
        words = text.split()  # Разбиваем входной запрос на слова
        found = False  # Флаг для обозначения наличия хотя бы одного совпадения
        ...
        for word in words:
            ...
            if results:  # Если для текущего слова найдены результаты
                found = True
        ...
        if not found:  # Если для всех слов не найдено ни одного совпадения
